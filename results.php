...
<html lang="en">
	<head>
  	...
  	<body>
  		<div class="main_wrapper" id="results">	
  			<!-- Navigation Section -->
			...
			<!-- Results Section -->
			<div id="results">
				<?php favourites(); ?>	<!-- Function to add favourites temporarly in an ip address/Customer id-->
				<?php
					if(isset($_GET['search'])){
						//Using the search query and displaying the highlights
						$search_query = $_GET['user_query'];
						$get_high = "select * from highlights where highlight_keyword like '%$search_query%'";
								...
								<div class='container'>
									<div class='row'>
										<div class='col-lg-12 text-center'>
										    ...
										    <h3 class='section-subheading text-muted'>These are the results of the points of interest you searched for.</h3>
										</div>
									</div>
								</div>
							</section>
				...
				<section id="portfolio" class="bg-light-gray">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-8 col-sm-6" id="resultsMid">
								<p class="text-muted"><?php echo "$high_name"; ?></p>
					            <p class="text-muted"><?php echo "$high_address"; ?></p>
								<p class="text-muted"><?php echo "$high_short_description"; ?></p>
