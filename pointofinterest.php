...
<html lang="en">
	<head>
  	...
  	<body>
  		<div class="main_wrapper" id="pointOfInterest">	
  			<!-- Navigation Section -->
  			<nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
			  	...
			  	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			    	<ul class="nav navbar-nav">
				      	...
				      	<li class="active"><a href="pointofinterest.php">PointOfInterest</a></li>
				      	<li>
					      	<a href="
					      		<?php
			...
			<div id="poi">
				<div id="highlights">
					<!-- function to add favourites temporarly in an ip address/ adding on their customer id-->
					<?php favourites(); ?>
							...
							<div class="row">
								<div class="col-lg-12 text-center">
									<h2 class="section-heading">Category</h2>
										<h3 class="section-subheading text-muted">These are some of the categories from the many events/highlights.</h3>
								</div>
							</div>
						</div>
					</section>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-4 col-sm-4">
									<a href="#">
									    <a href="<?php echo "results.php?user_query=trekking&search=" ?>"><img src="images/category/3.jpg" class="esponsive" alt="Trekking"></a>
					                </a>
					                <div class="places-caption">
				                        <p class="categoryList">Trekking</p>
									</div>
								</div>
								<div class="col-md-4 col-sm-4">
									<a href="#">
									    <a href="<?php echo "results.php?user_query=camping&search=" ?>"><img src="images/category/4.jpg" class="esponsive" alt="Camping"></a>
					                </a>
					                <div class="places-caption">
				                        <p class="categoryList">Camping</p>
									</div>
								</div>
								<div class="col-md-4 col-sm-4">
									<a href="#">
									    <a href="<?php echo "results.php?user_query=gliding&search=" ?>"><img src="images/category/6.jpg" class="esponsive" alt="Gliding"></a>
					                </a>
					                <div class="places-caption">
				                        <p class="categoryList">Gliding</p>
									</div>
								</div>
								<div class="col-md-4 col-sm-6">
									<a href="#">
									    <a href="<?php echo "results.php?user_query=hiking&search=" ?>"><img src="images/category/2.jpg" class="esponsive" alt="Hiking"></a>
					                </a>
					                <div class="places-caption">
				                        <p class="categoryList">Hiking</p>
									</div>
								</div>
								<div class="col-md-4 col-sm-6">
									<a href="#">
									    <a href="<?php echo "results.php?user_query=rafting&search=" ?>"><img src="images/category/5.jpg" class="esponsive" alt="Rafting"></a>
					                </a>
					                <div class="places-caption">
				                        <p class="categoryList">Rafting</p>
									</div>
								</div>
								<div class="col-md-4 col-sm-6">
									<a href="#">
									    <a href="<?php echo "results.php?user_query=sightseeing&search=" ?>"><img src="images/category/1.jpg" class="esponsive" alt="SightSeeing"></a>
					                </a>
					                <div class="places-caption">
				                        <p class="categoryList">SightSeeing</p>
									</div>
								</div>
							</div>
						</div>
					...
					<section id="portfolio" class="bg-light-gray">
						<div class="container">
							<div class="row">
								<div class="col-lg-12 text-center">
									<h2 class="section-heading">Points of Interest</h2>
								...
								<div class="col-md-4 col-sm-6">
									<div class="places-caption">
										    <p class="ted"><a href="<?php echo "pointofinterest.php?sort_id=1"; ?>"  ><button type="button" name="sortName" class="btn btn-primary">Sort Via Name</button></a></p>
										</div>
								</div>
								<div class="col-md-4 col-sm-6">
									<div class="places-caption">
										    <p class="ted"><a href="<?php echo "pointofinterest.php?sort_id=2"; ?>"  ><button type="button" name="sortAddress" class="btn btn-primary">Sort Via Address</button></a></p>
										</div>
								</div>
								<div class="col-md-4 col-sm-6">
										<div class="places-caption">
										    <p class="ted"><a href="<?php echo "pointofinterest.php?sort_id=3"; ?>"  ><button type="button" name="sortCategory" class="btn btn-primary">Sort Via Category </button></a></p>
										</div>
								</div>
							</div>
						</div>
					...
					<?php 
						//Initial 6 random datas from the database
						if (!isset($_GET['sort_id']) || !isset($_GET['sort_id']) || !isset($_GET['sort_id'])) {
					 ...
					 ?>	
					<!-- Visual Representation of those Random databases -->
					<section id="portfolio" class="bg-light-gray">
						<div class="container">
							<div class="row">
								<div class="col-md-4 col-sm-6">
								...
								<div class="col-md-8 col-sm-6">
									<p class="poiTitles"><?php echo "$high_name"; ?></p>
					                <p class="poiTitles"><?php echo "$high_address"; ?></p>
									<p><?php echo "$high_short_description"; ?></p>
									<div class="places-caption">
									    <p><a href="<?php echo "pointofinterest.php?add_favourite=$high_id"; ?>"  ><button type="button" class="btn btn-success" >Add to Favourites</button></a></p>
									</div>
								</div>
							</div>
							<br>
					...
					<?php } } }?>
					<?php
						if (isset($_GET['sort_id'])){	//we will create places variable in getPlaces(); //this is done for non-selected
							$sortId = $_GET['sort_id'];
							global $con;
							if ($sortId == 1) {
								$get_high = "select * from highlights order by highlight_name ASC";
								$run_high = mysqli_query($con, $get_high);
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-md-8 col-sm-6">
									...
									<p><?php echo "$high_short_description"; ?></p>
									<div class="places-caption">
									    <p class="text-muted"><a href="<?php echo "pointofinterest.php?add_favourite=$high_id"; ?>"  ><button type="button" class="btn btn-success">Add to Favourites</button></a></p>
									</div>
								</div>
							</div>
							<br>
					...
					<?php } } 
						if ($sortId == 2) {
							$get_high = "select * from highlights order by highlight_address ASC";
							$run_high = mysqli_query($con, $get_high);
							while ($row_high = mysqli_fetch_array($run_high)) {
								$high_id = $row_high['highlight_id'];
								$high_name = $row_high['highlight_name'];
					...
					<?php } } 
						if ($sortId == 3) {
							$get_high = "select * from highlights order by highlight_keyword ASC";
							$run_high = mysqli_query($con, $get_high);
							while ($row_high = mysqli_fetch_array($run_high)) {
								$high_id = $row_high['highlight_id'];
								$high_name = $row_high['highlight_name'];
